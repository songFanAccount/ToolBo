...
function LatexConverter() {
    ...
    return (
        ...
        >
            ...
            >
                {dimX > 0 && <SideBar toolName="LaTeX Converter" sections={sectionTitles}/>}
            </Box>
            <Box sx={{
                zIndex: 7,
                position: 'relative',
                ...
                <SectionBox>
                    <PageParagraph text=
                        ...
                        This may be resolved in future versions, if upcoming tools demands it.`}/>
                    <PageTextList
